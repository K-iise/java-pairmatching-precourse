...
import pairmatching.service.PairGenerator;
...
public class Application {
    public static void main(String[] args) {
        ...
        PairService pairService = new PairService(new CrewReader(), new PairGenerator());
        Controller controller = new Controller(inputView, outputView, validator, pairService);
